      ...
      <div class="col-12 col-sm-10 offset-sm-1 col-md-8 offset-md-2 col-lg-6 offset-lg-3">
        <div class="inner__card shadow-sm">
          <div class="card-body">
            <div class="container">
              <div class="row">
                <div class="col-8 offset-2 text-center my-4"><img src="<?php echo $img; ?>icons/employee.svg" alt=""></div>
                ...
                <div class="col-8 offset-2 text-center my-4"><a class="btn btn-primary btn-block btn-lg text-capitalize" href="registeration-worker-third.html">Add the service</a></div>
              </div>
            </div>
          </div>
        </div>
